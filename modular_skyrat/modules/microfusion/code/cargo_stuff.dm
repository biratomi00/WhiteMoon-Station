...
// /datum/supply_pack/security/microfusion // Вся вот эта хуйня перенесена в Company Imports в категорию Micron Control Systems.
...
// 	)
// 	crate_name = "MCR-01 Military Attachments Crate Type B" // Вся вот эта хуйня перенесена в Company Imports в категорию Micron Control Systems.
